...
exports.PaymentAccount = {
    ...
    fromAminoMsg(object) {
        return exports.PaymentAccount.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.PaymentAccount.decode(message.value);
    },
    toProto(message) {
        return exports.PaymentAccount.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.payment.PaymentAccount",
            value: exports.PaymentAccount.encode(message).finish()
        };
    }
};
