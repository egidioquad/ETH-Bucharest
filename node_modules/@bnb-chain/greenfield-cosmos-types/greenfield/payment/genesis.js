...
exports.GenesisState = {
    ...
    fromAmino(object) {
        ...
        message.streamRecordList = object.stream_record_list?.map(e => stream_record_1.StreamRecord.fromAmino(e)) || [];
        message.paymentAccountCountList = object.payment_account_count_list?.map(e => payment_account_count_1.PaymentAccountCount.fromAmino(e)) || [];
        message.paymentAccountList = object.payment_account_list?.map(e => payment_account_1.PaymentAccount.fromAmino(e)) || [];
        message.autoSettleRecordList = object.auto_settle_record_list?.map(e => auto_settle_record_1.AutoSettleRecord.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.streamRecordList) {
            obj.stream_record_list = message.streamRecordList.map(e => e ? stream_record_1.StreamRecord.toAmino(e) : undefined);
        }
        else {
            obj.stream_record_list = [];
        }
        if (message.paymentAccountCountList) {
            obj.payment_account_count_list = message.paymentAccountCountList.map(e => e ? payment_account_count_1.PaymentAccountCount.toAmino(e) : undefined);
        }
        else {
            obj.payment_account_count_list = [];
        }
        if (message.paymentAccountList) {
            obj.payment_account_list = message.paymentAccountList.map(e => e ? payment_account_1.PaymentAccount.toAmino(e) : undefined);
        }
        else {
            obj.payment_account_list = [];
        }
        if (message.autoSettleRecordList) {
            obj.auto_settle_record_list = message.autoSettleRecordList.map(e => e ? auto_settle_record_1.AutoSettleRecord.toAmino(e) : undefined);
        }
        else {
            obj.auto_settle_record_list = [];
        }
