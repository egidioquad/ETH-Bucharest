...
exports.AutoSettleRecord = {
    ...
    fromAminoMsg(object) {
        return exports.AutoSettleRecord.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.AutoSettleRecord.decode(message.value);
    },
    toProto(message) {
        return exports.AutoSettleRecord.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.payment.AutoSettleRecord",
            value: exports.AutoSettleRecord.encode(message).finish()
        };
    }
};
