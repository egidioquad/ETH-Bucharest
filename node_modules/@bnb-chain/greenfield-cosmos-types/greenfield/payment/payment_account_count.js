...
exports.PaymentAccountCount = {
    ...
    fromAmino(object) {
        ...
        if (object.count !== undefined && object.count !== null) {
            message.count = helpers_1.Long.fromString(object.count);
        }
        return message;
    },
    toAmino(message) {
    ...
    fromAminoMsg(object) {
        return exports.PaymentAccountCount.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.PaymentAccountCount.decode(message.value);
    },
    toProto(message) {
        return exports.PaymentAccountCount.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.payment.PaymentAccountCount",
            value: exports.PaymentAccountCount.encode(message).finish()
        };
    }
};
