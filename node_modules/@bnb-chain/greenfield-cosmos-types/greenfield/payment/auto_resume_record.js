...
exports.AutoResumeRecord = {
    ...
    fromAminoMsg(object) {
        return exports.AutoResumeRecord.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.AutoResumeRecord.decode(message.value);
    },
    toProto(message) {
        return exports.AutoResumeRecord.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.payment.AutoResumeRecord",
            value: exports.AutoResumeRecord.encode(message).finish()
        };
    }
};
