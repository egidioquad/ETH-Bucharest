...
exports.GenesisState = {
    ...
    fromAmino(object) {
        ...
        message.storageProviders = object.storage_providers?.map(e => types_1.StorageProvider.fromAmino(e)) || [];
        message.spStoragePriceList = object.sp_storage_price_list?.map(e => types_1.SpStoragePrice.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.storageProviders) {
            obj.storage_providers = message.storageProviders.map(e => e ? types_1.StorageProvider.toAmino(e) : undefined);
        }
        else {
            obj.storage_providers = [];
        }
        if (message.spStoragePriceList) {
            obj.sp_storage_price_list = message.spStoragePriceList.map(e => e ? types_1.SpStoragePrice.toAmino(e) : undefined);
        }
        else {
            obj.sp_storage_price_list = [];
        }
