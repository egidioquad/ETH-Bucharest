...
exports.Principal = exports.Statement = exports.principalTypeToJSON = exports.principalTypeFromJSON = exports.PrincipalTypeAmino = exports.PrincipalTypeSDKType = exports.PrincipalType = exports.effectToJSON = exports.effectFromJSON = exports.EffectAmino = exports.EffectSDKType = exports.Effect = exports.actionTypeToJSON = exports.actionTypeFromJSON = exports.ActionTypeAmino = exports.ActionTypeSDKType = exports.ActionType = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.ActionTypeAmino = ActionType;
...
exports.PrincipalTypeAmino = PrincipalType;
...
exports.Statement = {
    ...
    fromAmino(object) {
        ...
        if (object.limit_size !== undefined && object.limit_size !== null) {
            message.limitSize = wrapper_1.UInt64Value.fromAmino(object.limit_size);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.limit_size = message.limitSize ? wrapper_1.UInt64Value.toAmino(message.limitSize) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.Statement.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Statement.decode(message.value);
    },
    toProto(message) {
        return exports.Statement.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.permission.Statement",
            value: exports.Statement.encode(message).finish()
        };
    }
};
...
exports.Principal = {
    ...
    fromAminoMsg(object) {
        return exports.Principal.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Principal.decode(message.value);
    },
    toProto(message) {
        return exports.Principal.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.permission.Principal",
            value: exports.Principal.encode(message).finish()
        };
    }
};
