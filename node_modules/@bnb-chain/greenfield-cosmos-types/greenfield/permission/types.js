...
exports.Policy = {
    ...
    fromAmino(object) {
        ...
        if (object.principal !== undefined && object.principal !== null) {
            message.principal = common_1.Principal.fromAmino(object.principal);
        }
        if (object.resource_type !== undefined && object.resource_type !== null) {
            message.resourceType = (0, types_1.resourceTypeFromJSON)(object.resource_type);
        }
        if (object.resource_id !== undefined && object.resource_id !== null) {
            message.resourceId = object.resource_id;
        }
        message.statements = object.statements?.map(e => common_1.Statement.fromAmino(e)) || [];
    ...
    toAmino(message) {
        const obj = {};
        obj.id = message.id;
        obj.principal = message.principal ? common_1.Principal.toAmino(message.principal) : undefined;
        obj.resource_type = (0, types_1.resourceTypeToJSON)(message.resourceType);
        obj.resource_id = message.resourceId;
        if (message.statements) {
            obj.statements = message.statements.map(e => e ? common_1.Statement.toAmino(e) : undefined);
        }
        else {
            obj.statements = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.Policy.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Policy.decode(message.value);
    },
    toProto(message) {
        return exports.Policy.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.permission.Policy",
            value: exports.Policy.encode(message).finish()
        };
    }
};
...
exports.PolicyGroup = {
    ...
    fromAmino(object) {
        const message = createBasePolicyGroup();
        message.items = object.items?.map(e => exports.PolicyGroup_Item.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        if (message.items) {
            obj.items = message.items.map(e => e ? exports.PolicyGroup_Item.toAmino(e) : undefined);
        }
        else {
            obj.items = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.PolicyGroup.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.PolicyGroup.decode(message.value);
    },
    toProto(message) {
        return exports.PolicyGroup.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.permission.PolicyGroup",
            value: exports.PolicyGroup.encode(message).finish()
        };
    }
};
...
exports.PolicyGroup_Item = {
    ...
    fromAminoMsg(object) {
        return exports.PolicyGroup_Item.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.PolicyGroup_Item.decode(message.value);
    },
    toProto(message) {
        return exports.PolicyGroup_Item.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.permission.Item",
            value: exports.PolicyGroup_Item.encode(message).finish()
        };
    }
};
