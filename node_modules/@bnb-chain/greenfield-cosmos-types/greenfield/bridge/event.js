...
exports.EventCrossTransferIn = exports.EventCrossTransferOutRefund = exports.EventCrossTransferOut = exports.refundReasonToJSON = exports.refundReasonFromJSON = exports.RefundReasonAmino = exports.RefundReasonSDKType = exports.RefundReason = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.RefundReasonAmino = RefundReason;
...
exports.EventCrossTransferOut = {
    ...
    fromAmino(object) {
        ...
        if (object.relayer_fee !== undefined && object.relayer_fee !== null) {
            message.relayerFee = coin_1.Coin.fromAmino(object.relayer_fee);
        }
    ...
    toAmino(message) {
        ...
        obj.relayer_fee = message.relayerFee ? coin_1.Coin.toAmino(message.relayerFee) : undefined;
        obj.sequence = message.sequence ? message.sequence.toString() : undefined;
        obj.dest_chain_id = message.destChainId;
        return obj;
    },
    fromAminoMsg(object) {
        return exports.EventCrossTransferOut.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventCrossTransferOut.decode(message.value);
    },
    toProto(message) {
        return exports.EventCrossTransferOut.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.bridge.EventCrossTransferOut",
            value: exports.EventCrossTransferOut.encode(message).finish()
        };
    }
};
...
exports.EventCrossTransferOutRefund = {
    ...
    fromAminoMsg(object) {
        return exports.EventCrossTransferOutRefund.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventCrossTransferOutRefund.decode(message.value);
    },
    toProto(message) {
        return exports.EventCrossTransferOutRefund.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.bridge.EventCrossTransferOutRefund",
            value: exports.EventCrossTransferOutRefund.encode(message).finish()
        };
    }
};
...
exports.EventCrossTransferIn = {
    ...
    fromAminoMsg(object) {
        return exports.EventCrossTransferIn.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.EventCrossTransferIn.decode(message.value);
    },
    toProto(message) {
        return exports.EventCrossTransferIn.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.bridge.EventCrossTransferIn",
            value: exports.EventCrossTransferIn.encode(message).finish()
        };
    }
};
