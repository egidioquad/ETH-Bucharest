...
exports.Approval = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.Approval = {
    ...
    fromAminoMsg(object) {
        return exports.Approval.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Approval.decode(message.value);
    },
    toProto(message) {
        return exports.Approval.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/greenfield.common.Approval",
            value: exports.Approval.encode(message).finish()
        };
    }
};
