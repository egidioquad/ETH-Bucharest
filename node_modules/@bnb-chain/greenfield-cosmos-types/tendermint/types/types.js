...
exports.Reveal = exports.TxProof = exports.BlockMeta = exports.LightBlock = exports.SignedHeader = exports.Proposal = exports.CommitSig = exports.Commit = exports.Vote = exports.Data = exports.Header = exports.BlockID = exports.Part = exports.PartSetHeader = exports.signedMsgTypeToJSON = exports.signedMsgTypeFromJSON = exports.SignedMsgTypeAmino = exports.SignedMsgTypeSDKType = exports.SignedMsgType = exports.blockIDFlagToJSON = exports.blockIDFlagFromJSON = exports.BlockIDFlagAmino = exports.BlockIDFlagSDKType = exports.BlockIDFlag = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.Vote = {
    ...
    fromAmino(object) {
        ...
        if (object.timestamp !== undefined && object.timestamp !== null) {
            message.timestamp = timestamp_1.Timestamp.fromAmino(object.timestamp);
        }
    ...
    toAmino(message) {
        ...
        obj.timestamp = message.timestamp ? timestamp_1.Timestamp.toAmino(message.timestamp) : undefined;
...
exports.BlockMeta = {
    ...
    fromAmino(object) {
        ...
        if (object.block_size !== undefined && object.block_size !== null) {
            message.blockSize = helpers_1.Long.fromString(object.block_size);
        }
        if (object.header !== undefined && object.header !== null) {
            message.header = exports.Header.fromAmino(object.header);
        }
        if (object.num_txs !== undefined && object.num_txs !== null) {
            message.numTxs = helpers_1.Long.fromString(object.num_txs);
        }
        return message;
    },
    toAmino(message) {
...
exports.Reveal = {
    ...
    fromAminoMsg(object) {
        return exports.Reveal.fromAmino(object.value);
    },
    fromProtoMsg(message) {
        return exports.Reveal.decode(message.value);
    },
    toProto(message) {
        return exports.Reveal.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/tendermint.types.Reveal",
            value: exports.Reveal.encode(message).finish()
        };
    }
};
