...
exports.BlockParams = {
    ...
    fromAmino(object) {
        ...
        if (object.max_bytes !== undefined && object.max_bytes !== null) {
            message.maxBytes = helpers_1.Long.fromString(object.max_bytes);
        }
        if (object.max_gas !== undefined && object.max_gas !== null) {
            message.maxGas = helpers_1.Long.fromString(object.max_gas);
        }
        return message;
    },
    toAmino(message) {
...
exports.EvidenceParams = {
    ...
    fromAmino(object) {
        ...
        if (object.max_age_num_blocks !== undefined && object.max_age_num_blocks !== null) {
            message.maxAgeNumBlocks = helpers_1.Long.fromString(object.max_age_num_blocks);
        }
...
exports.VersionParams = {
    ...
    fromAmino(object) {
        ...
        if (object.app !== undefined && object.app !== null) {
            message.app = helpers_1.Long.fromString(object.app);
        }
        return message;
    },
    toAmino(message) {
...
exports.HashedParams = {
    ...
    fromAmino(object) {
        ...
        if (object.block_max_bytes !== undefined && object.block_max_bytes !== null) {
            message.blockMaxBytes = helpers_1.Long.fromString(object.block_max_bytes);
        }
        if (object.block_max_gas !== undefined && object.block_max_gas !== null) {
            message.blockMaxGas = helpers_1.Long.fromString(object.block_max_gas);
        }
        return message;
    },
    toAmino(message) {
