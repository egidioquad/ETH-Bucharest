...
exports.PageRequest = {
    ...
    fromAmino(object) {
        ...
        if (object.offset !== undefined && object.offset !== null) {
            message.offset = helpers_1.Long.fromString(object.offset);
        }
        if (object.limit !== undefined && object.limit !== null) {
            message.limit = helpers_1.Long.fromString(object.limit);
        }
...
exports.PageResponse = {
    ...
    fromAmino(object) {
        ...
        if (object.total !== undefined && object.total !== null) {
            message.total = helpers_1.Long.fromString(object.total);
        }
        return message;
    },
    toAmino(message) {
