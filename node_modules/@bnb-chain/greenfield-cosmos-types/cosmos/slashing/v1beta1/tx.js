...
exports.MsgUpdateParams = {
    ...
    toAmino(message) {
        const obj = {};
        obj.authority = message.authority;
        obj.params = message.params ? slashing_1.Params.toAmino(message.params) : slashing_1.Params.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.MsgImpeach = {
    ...
    fromAminoMsg(object) {
        return exports.MsgImpeach.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/MsgImpeach",
            value: exports.MsgImpeach.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.MsgImpeach.decode(message.value);
    },
    toProto(message) {
        return exports.MsgImpeach.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.slashing.v1beta1.MsgImpeach",
            value: exports.MsgImpeach.encode(message).finish()
        };
    }
};
...
exports.MsgImpeachResponse = {
    ...
    fromAminoMsg(object) {
        return exports.MsgImpeachResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/MsgImpeachResponse",
            value: exports.MsgImpeachResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.MsgImpeachResponse.decode(message.value);
    },
    toProto(message) {
        return exports.MsgImpeachResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.slashing.v1beta1.MsgImpeachResponse",
            value: exports.MsgImpeachResponse.encode(message).finish()
        };
    }
};
class MsgClientImpl {
