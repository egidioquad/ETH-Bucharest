...
exports.SigningInfo = {
    ...
    toAmino(message) {
        const obj = {};
        obj.address = message.address;
        obj.validator_signing_info = message.validatorSigningInfo ? slashing_1.ValidatorSigningInfo.toAmino(message.validatorSigningInfo) : slashing_1.ValidatorSigningInfo.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
