...
exports.QuerySigningInfoResponse = {
    ...
    toAmino(message) {
        const obj = {};
        obj.val_signing_info = message.valSigningInfo ? slashing_1.ValidatorSigningInfo.toAmino(message.valSigningInfo) : slashing_1.ValidatorSigningInfo.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
