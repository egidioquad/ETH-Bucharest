...
exports.ValidatorSigningInfo = {
    ...
    fromAmino(object) {
        ...
        if (object.start_height !== undefined && object.start_height !== null) {
            message.startHeight = helpers_1.Long.fromString(object.start_height);
        }
        if (object.index_offset !== undefined && object.index_offset !== null) {
            message.indexOffset = helpers_1.Long.fromString(object.index_offset);
        }
        if (object.jailed_until !== undefined && object.jailed_until !== null) {
            message.jailedUntil = timestamp_1.Timestamp.fromAmino(object.jailed_until);
        }
        if (object.tombstoned !== undefined && object.tombstoned !== null) {
            message.tombstoned = object.tombstoned;
        }
        if (object.missed_blocks_counter !== undefined && object.missed_blocks_counter !== null) {
            message.missedBlocksCounter = helpers_1.Long.fromString(object.missed_blocks_counter);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.jailed_until = message.jailedUntil ? timestamp_1.Timestamp.toAmino(message.jailedUntil) : timestamp_1.Timestamp.fromPartial({});
        obj.tombstoned = message.tombstoned;
...
exports.Params = {
    ...
    fromAmino(object) {
        ...
        if (object.signed_blocks_window !== undefined && object.signed_blocks_window !== null) {
            message.signedBlocksWindow = helpers_1.Long.fromString(object.signed_blocks_window);
        }
    ...
    toAmino(message) {
        ...
        obj.downtime_jail_duration = message.downtimeJailDuration ? duration_1.Duration.toAmino(message.downtimeJailDuration) : duration_1.Duration.fromPartial({});
