...
exports.BaseVestingAccount = {
    ...
    fromAmino(object) {
        ...
        if (object.end_time !== undefined && object.end_time !== null) {
            message.endTime = helpers_1.Long.fromString(object.end_time);
        }
        return message;
    },
    toAmino(message) {
...
exports.ContinuousVestingAccount = {
    ...
    fromAmino(object) {
        ...
        if (object.start_time !== undefined && object.start_time !== null) {
            message.startTime = helpers_1.Long.fromString(object.start_time);
        }
        return message;
    },
    toAmino(message) {
...
exports.Period = {
    ...
    fromAmino(object) {
        ...
        if (object.length !== undefined && object.length !== null) {
            message.length = helpers_1.Long.fromString(object.length);
        }
