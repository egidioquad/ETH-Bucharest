...
exports.EventCrossChain = {
    ...
    fromAminoMsg(object) {
        return exports.EventCrossChain.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/EventCrossChain",
            value: exports.EventCrossChain.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.EventCrossChain.decode(message.value);
    },
    toProto(message) {
        return exports.EventCrossChain.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.crosschain.v1.EventCrossChain",
            value: exports.EventCrossChain.encode(message).finish()
        };
    }
};
