...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.slashing.v1beta1.MsgImpeach": {
        aminoType: string;
        toAmino: (message: import("./slashing/v1beta1/tx").MsgImpeach) => import("./slashing/v1beta1/tx").MsgImpeachAmino;
        fromAmino: (object: import("./slashing/v1beta1/tx").MsgImpeachAmino) => import("./slashing/v1beta1/tx").MsgImpeach;
    };
    "/cosmos.oracle.v1.MsgClaim": {
        aminoType: string;
        toAmino: (message: import("./oracle/v1/tx").MsgClaim) => import("./oracle/v1/tx").MsgClaimAmino;
        fromAmino: (object: import("./oracle/v1/tx").MsgClaimAmino) => import("./oracle/v1/tx").MsgClaim;
    };
    "/cosmos.oracle.v1.MsgUpdateParams": {
        aminoType: string;
        toAmino: (message: import("./oracle/v1/tx").MsgUpdateParams) => import("./oracle/v1/tx").MsgUpdateParamsAmino;
        fromAmino: (object: import("./oracle/v1/tx").MsgUpdateParamsAmino) => import("./oracle/v1/tx").MsgUpdateParams;
    };
    ...
    "/cosmos.gov.v1.MsgUpdateCrossChainParams": {
        aminoType: string;
        toAmino: (message: import("./gov/v1/tx").MsgUpdateCrossChainParams) => import("./gov/v1/tx").MsgUpdateCrossChainParamsAmino;
        fromAmino: (object: import("./gov/v1/tx").MsgUpdateCrossChainParamsAmino) => import("./gov/v1/tx").MsgUpdateCrossChainParams;
    };
    "/cosmos.gashub.v1beta1.MsgUpdateParams": {
        aminoType: string;
        toAmino: (message: import("./gashub/v1beta1/tx").MsgUpdateParams) => import("./gashub/v1beta1/tx").MsgUpdateParamsAmino;
        fromAmino: (object: import("./gashub/v1beta1/tx").MsgUpdateParamsAmino) => import("./gashub/v1beta1/tx").MsgUpdateParams;
    };
    "/cosmos.gashub.v1beta1.MsgSetMsgGasParams": {
        aminoType: string;
        toAmino: (message: import("./gashub/v1beta1/tx").MsgSetMsgGasParams) => import("./gashub/v1beta1/tx").MsgSetMsgGasParamsAmino;
        fromAmino: (object: import("./gashub/v1beta1/tx").MsgSetMsgGasParamsAmino) => import("./gashub/v1beta1/tx").MsgSetMsgGasParams;
    };
    ...
    "/cosmos.crosschain.v1.MsgUpdateParams": {
        aminoType: string;
        toAmino: (message: import("./crosschain/v1/tx").MsgUpdateParams) => import("./crosschain/v1/tx").MsgUpdateParamsAmino;
        fromAmino: (object: import("./crosschain/v1/tx").MsgUpdateParamsAmino) => import("./crosschain/v1/tx").MsgUpdateParams;
    };
    "/cosmos.crosschain.v1.MsgUpdateChannelPermissions": {
        aminoType: string;
        toAmino: (message: import("./crosschain/v1/tx").MsgUpdateChannelPermissions) => import("./crosschain/v1/tx").MsgUpdateChannelPermissionsAmino;
        fromAmino: (object: import("./crosschain/v1/tx").MsgUpdateChannelPermissionsAmino) => import("./crosschain/v1/tx").MsgUpdateChannelPermissions;
    };
    "/cosmos.crosschain.v1.MsgMintModuleTokens": {
        aminoType: string;
        toAmino: (message: import("./crosschain/v1/tx").MsgMintModuleTokens) => import("./crosschain/v1/tx").MsgMintModuleTokensAmino;
        fromAmino: (object: import("./crosschain/v1/tx").MsgMintModuleTokensAmino) => import("./crosschain/v1/tx").MsgMintModuleTokens;
    };
