...
exports.BasicAllowance = {
    ...
    fromAmino(object) {
        ...
        if (object.expiration !== undefined && object.expiration !== null) {
            message.expiration = timestamp_1.Timestamp.fromAmino(object.expiration);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.expiration = message.expiration ? timestamp_1.Timestamp.toAmino(message.expiration) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.PeriodicAllowance = {
    ...
    fromAmino(object) {
        ...
        if (object.period_reset !== undefined && object.period_reset !== null) {
            message.periodReset = timestamp_1.Timestamp.fromAmino(object.period_reset);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.period_reset = message.periodReset ? timestamp_1.Timestamp.toAmino(message.periodReset) : timestamp_1.Timestamp.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
