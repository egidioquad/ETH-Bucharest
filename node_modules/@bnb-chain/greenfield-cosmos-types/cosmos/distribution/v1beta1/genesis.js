...
exports.ValidatorHistoricalRewardsRecord = {
    ...
    fromAmino(object) {
        ...
        if (object.period !== undefined && object.period !== null) {
            message.period = helpers_1.Long.fromString(object.period);
        }
...
exports.DelegatorStartingInfoRecord = {
    ...
    toAmino(message) {
        ...
        obj.delegator_address = message.delegatorAddress;
        obj.validator_address = message.validatorAddress;
        obj.starting_info = message.startingInfo ? distribution_1.DelegatorStartingInfo.toAmino(message.startingInfo) : distribution_1.DelegatorStartingInfo.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.ValidatorSlashEventRecord = {
    ...
    toAmino(message) {
        ...
        obj.period = message.period ? message.period.toString() : undefined;
        obj.validator_slash_event = message.validatorSlashEvent ? distribution_1.ValidatorSlashEvent.toAmino(message.validatorSlashEvent) : distribution_1.ValidatorSlashEvent.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GenesisState = {
    ...
    toAmino(message) {
        ...
        obj.fee_pool = message.feePool ? distribution_1.FeePool.toAmino(message.feePool) : distribution_1.FeePool.fromPartial({});
        if (message.delegatorWithdrawInfos) {
