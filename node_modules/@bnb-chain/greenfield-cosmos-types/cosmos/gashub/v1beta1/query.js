...
exports.QueryMsgGasParamsRequest = {
    ...
    fromAminoMsg(object) {
        return exports.QueryMsgGasParamsRequest.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/QueryMsgGasParamsRequest",
            value: exports.QueryMsgGasParamsRequest.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.QueryMsgGasParamsRequest.decode(message.value);
    },
    toProto(message) {
        return exports.QueryMsgGasParamsRequest.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.gashub.v1beta1.QueryMsgGasParamsRequest",
            value: exports.QueryMsgGasParamsRequest.encode(message).finish()
        };
    }
};
...
exports.QueryMsgGasParamsResponse = {
    ...
    fromAmino(object) {
        const message = createBaseQueryMsgGasParamsResponse();
        message.msgGasParams = object.msg_gas_params?.map(e => gashub_1.MsgGasParams.fromAmino(e)) || [];
        if (object.pagination !== undefined && object.pagination !== null) {
    ...
    toAmino(message) {
        const obj = {};
        if (message.msgGasParams) {
            obj.msg_gas_params = message.msgGasParams.map(e => e ? gashub_1.MsgGasParams.toAmino(e) : undefined);
        }
        else {
            obj.msg_gas_params = [];
        }
    ...
    fromAminoMsg(object) {
        return exports.QueryMsgGasParamsResponse.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/QueryMsgGasParamsResponse",
            value: exports.QueryMsgGasParamsResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.QueryMsgGasParamsResponse.decode(message.value);
    },
    toProto(message) {
        return exports.QueryMsgGasParamsResponse.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.gashub.v1beta1.QueryMsgGasParamsResponse",
            value: exports.QueryMsgGasParamsResponse.encode(message).finish()
        };
    }
};
