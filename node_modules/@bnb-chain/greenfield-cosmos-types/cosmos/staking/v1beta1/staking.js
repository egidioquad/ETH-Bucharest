...
exports.Commission = {
    ...
    fromAmino(object) {
        ...
        if (object.update_time !== undefined && object.update_time !== null) {
            message.updateTime = timestamp_1.Timestamp.fromAmino(object.update_time);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.commission_rates = message.commissionRates ? exports.CommissionRates.toAmino(message.commissionRates) : exports.CommissionRates.fromPartial({});
        obj.update_time = message.updateTime ? timestamp_1.Timestamp.toAmino(message.updateTime) : timestamp_1.Timestamp.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Validator = {
    ...
    fromAmino(object) {
        ...
        if (object.unbonding_height !== undefined && object.unbonding_height !== null) {
            message.unbondingHeight = helpers_1.Long.fromString(object.unbonding_height);
        }
        if (object.unbonding_time !== undefined && object.unbonding_time !== null) {
            message.unbondingTime = timestamp_1.Timestamp.fromAmino(object.unbonding_time);
        }
        ...
        if (object.unbonding_on_hold_ref_count !== undefined && object.unbonding_on_hold_ref_count !== null) {
            message.unbondingOnHoldRefCount = helpers_1.Long.fromString(object.unbonding_on_hold_ref_count);
        }
        message.unbondingIds = object.unbonding_ids?.map(e => helpers_1.Long.fromString(e)) || [];
        ...
        if (object.bls_key !== undefined && object.bls_key !== null) {
            message.blsKey = (0, helpers_1.bytesFromBase64)(object.bls_key);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.unbonding_time = message.unbondingTime ? timestamp_1.Timestamp.toAmino(message.unbondingTime) : timestamp_1.Timestamp.fromPartial({});
        ...
        obj.relayer_address = message.relayerAddress;
        obj.challenger_address = message.challengerAddress;
        obj.bls_key = message.blsKey ? (0, helpers_1.base64FromBytes)(message.blsKey) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.UnbondingDelegationEntry = {
    ...
    fromAmino(object) {
        ...
        if (object.creation_height !== undefined && object.creation_height !== null) {
            message.creationHeight = helpers_1.Long.fromString(object.creation_height);
        }
        if (object.completion_time !== undefined && object.completion_time !== null) {
            message.completionTime = timestamp_1.Timestamp.fromAmino(object.completion_time);
        }
        ...
        if (object.unbonding_id !== undefined && object.unbonding_id !== null) {
            message.unbondingId = helpers_1.Long.fromString(object.unbonding_id);
        }
        if (object.unbonding_on_hold_ref_count !== undefined && object.unbonding_on_hold_ref_count !== null) {
            message.unbondingOnHoldRefCount = helpers_1.Long.fromString(object.unbonding_on_hold_ref_count);
        }
    ...
    toAmino(message) {
        ...
        obj.completion_time = message.completionTime ? timestamp_1.Timestamp.toAmino(message.completionTime) : timestamp_1.Timestamp.fromPartial({});
        obj.initial_balance = message.initialBalance;
        obj.balance = message.balance;
...
exports.Params = {
    ...
    toAmino(message) {
        const obj = {};
        obj.unbonding_time = message.unbondingTime ? duration_1.Duration.toAmino(message.unbondingTime) : duration_1.Duration.fromPartial({});
        obj.max_validators = message.maxValidators;
        obj.max_entries = message.maxEntries;
        obj.historical_entries = message.historicalEntries;
        obj.bond_denom = message.bondDenom;
...
exports.RedelegationEntryResponse = {
    ...
    toAmino(message) {
        const obj = {};
        obj.redelegation_entry = message.redelegationEntry ? exports.RedelegationEntry.toAmino(message.redelegationEntry) : exports.RedelegationEntry.fromPartial({});
        obj.balance = message.balance;
        return obj;
    },
    fromAminoMsg(object) {
