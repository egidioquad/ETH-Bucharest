...
exports.Config = {
    ...
    fromAmino(object) {
        ...
        message.golangBindings = object.golang_bindings?.map(e => exports.GolangBinding.fromAmino(e)) || [];
        return message;
    },
    toAmino(message) {
        const obj = {};
        ...
        if (message.golangBindings) {
            obj.golang_bindings = message.golangBindings.map(e => e ? exports.GolangBinding.toAmino(e) : undefined);
        }
        else {
            obj.golang_bindings = [];
        }
