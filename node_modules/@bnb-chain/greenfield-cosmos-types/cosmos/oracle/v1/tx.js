...
exports.MsgClaim = {
    ...
    fromAmino(object) {
        ...
        message.voteAddressSet = object.vote_address_set?.map(e => helpers_1.Long.fromString(e)) || [];
        if (object.agg_signature !== undefined && object.agg_signature !== null) {
            message.aggSignature = (0, helpers_1.bytesFromBase64)(object.agg_signature);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.agg_signature = message.aggSignature ? (0, helpers_1.base64FromBytes)(message.aggSignature) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
    ...
    toAminoMsg(message) {
        return {
            ...
            value: exports.MsgClaim.toAmino(message)
        };
    },
...
exports.MsgClaimResponse = {
    ...
    toAminoMsg(message) {
        return {
            ...
            value: exports.MsgClaimResponse.toAmino(message)
        };
    },
    fromProtoMsg(message) {
...
exports.MsgUpdateParams = {
    ...
    toAmino(message) {
        const obj = {};
        obj.authority = message.authority;
        obj.params = message.params ? oracle_1.Params.toAmino(message.params) : oracle_1.Params.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
