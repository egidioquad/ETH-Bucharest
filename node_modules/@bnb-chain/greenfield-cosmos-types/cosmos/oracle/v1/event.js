...
exports.EventPackageClaim = {
    ...
    fromAmino(object) {
        ...
        if (object.receive_sequence !== undefined && object.receive_sequence !== null) {
            message.receiveSequence = helpers_1.Long.fromString(object.receive_sequence);
        }
        if (object.send_sequence !== undefined && object.send_sequence !== null) {
            message.sendSequence = helpers_1.Long.fromString(object.send_sequence);
        }
    ...
    fromAminoMsg(object) {
        return exports.EventPackageClaim.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/EventPackageClaim",
            value: exports.EventPackageClaim.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.EventPackageClaim.decode(message.value);
    },
    toProto(message) {
        return exports.EventPackageClaim.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.oracle.v1.EventPackageClaim",
            value: exports.EventPackageClaim.encode(message).finish()
        };
    }
};
