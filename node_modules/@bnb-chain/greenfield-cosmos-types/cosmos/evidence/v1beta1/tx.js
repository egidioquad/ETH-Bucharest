...
exports.MsgClientImpl = exports.Cosmos_evidencev1beta1Evidence_ToAmino = exports.Cosmos_evidencev1beta1Evidence_FromAmino = exports.Cosmos_evidencev1beta1Evidence_InterfaceDecoder = exports.MsgSubmitEvidenceResponse = exports.MsgSubmitEvidence = exports.protobufPackage = void 0;
//@ts-nocheck
/* eslint-disable */
...
exports.MsgSubmitEvidence = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.evidence = (0, exports.Cosmos_evidencev1beta1Evidence_InterfaceDecoder)(reader);
                    break;
                default:
    ...
    fromAmino(object) {
        ...
        if (object.evidence !== undefined && object.evidence !== null) {
            message.evidence = (0, exports.Cosmos_evidencev1beta1Evidence_FromAmino)(object.evidence);
        }
        return message;
    },
    toAmino(message) {
        const obj = {};
        obj.submitter = message.submitter;
        obj.evidence = message.evidence ? (0, exports.Cosmos_evidencev1beta1Evidence_ToAmino)(message.evidence) : undefined;
        return obj;
    },
    fromAminoMsg(object) {
...
exports.Cosmos_evidencev1beta1Evidence_InterfaceDecoder = Cosmos_evidencev1beta1Evidence_InterfaceDecoder;
const Cosmos_evidencev1beta1Evidence_FromAmino = (content) => {
    return any_1.Any.fromAmino(content);
};
exports.Cosmos_evidencev1beta1Evidence_FromAmino = Cosmos_evidencev1beta1Evidence_FromAmino;
const Cosmos_evidencev1beta1Evidence_ToAmino = (content) => {
    return any_1.Any.toAmino(content);
};
exports.Cosmos_evidencev1beta1Evidence_ToAmino = Cosmos_evidencev1beta1Evidence_ToAmino;
class MsgClientImpl {
    constructor(rpc) {
        this.rpc = rpc;
