...
exports.SignDoc = {
    ...
    fromAmino(object) {
        ...
        if (object.account_number !== undefined && object.account_number !== null) {
            message.accountNumber = helpers_1.Long.fromString(object.account_number);
        }
        return message;
    },
    toAmino(message) {
...
exports.SignDocEip712 = {
    ...
    fromAmino(object) {
        const message = createBaseSignDocEip712();
        if (object.chain_id !== undefined && object.chain_id !== null) {
            message.chainId = helpers_1.Long.fromString(object.chain_id);
        }
        if (object.account_number !== undefined && object.account_number !== null) {
            message.accountNumber = helpers_1.Long.fromString(object.account_number);
        }
        ...
        if (object.timeout_height !== undefined && object.timeout_height !== null) {
            message.timeoutHeight = helpers_1.Long.fromString(object.timeout_height);
        }
    ...
    fromAminoMsg(object) {
        return exports.SignDocEip712.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/SignDocEip712",
            value: exports.SignDocEip712.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.SignDocEip712.decode(message.value);
    },
    toProto(message) {
        return exports.SignDocEip712.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.tx.v1beta1.SignDocEip712",
            value: exports.SignDocEip712.encode(message).finish()
        };
    }
};
...
exports.Fee = {
    ...
    fromAmino(object) {
        ...
        if (object.gas_limit !== undefined && object.gas_limit !== null) {
            message.gasLimit = helpers_1.Long.fromString(object.gas_limit);
        }
