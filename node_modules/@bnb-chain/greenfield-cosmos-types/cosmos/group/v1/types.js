...
exports.Member = {
    ...
    fromAmino(object) {
        ...
        if (object.added_at !== undefined && object.added_at !== null) {
            message.addedAt = timestamp_1.Timestamp.fromAmino(object.added_at);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.weight = message.weight;
        obj.metadata = message.metadata;
        obj.added_at = message.addedAt ? timestamp_1.Timestamp.toAmino(message.addedAt) : timestamp_1.Timestamp.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.DecisionPolicyWindows = {
    ...
    toAmino(message) {
        const obj = {};
        obj.voting_period = message.votingPeriod ? duration_1.Duration.toAmino(message.votingPeriod) : duration_1.Duration.fromPartial({});
        obj.min_execution_period = message.minExecutionPeriod ? duration_1.Duration.toAmino(message.minExecutionPeriod) : duration_1.Duration.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GroupInfo = {
    ...
    fromAmino(object) {
        ...
        if (object.version !== undefined && object.version !== null) {
            message.version = helpers_1.Long.fromString(object.version);
        }
        if (object.total_weight !== undefined && object.total_weight !== null) {
            message.totalWeight = object.total_weight;
        }
        if (object.created_at !== undefined && object.created_at !== null) {
            message.createdAt = timestamp_1.Timestamp.fromAmino(object.created_at);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.total_weight = message.totalWeight;
        obj.created_at = message.createdAt ? timestamp_1.Timestamp.toAmino(message.createdAt) : timestamp_1.Timestamp.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
exports.GroupMember = {
    ...
    fromAmino(object) {
        ...
        if (object.group_id !== undefined && object.group_id !== null) {
            message.groupId = helpers_1.Long.fromString(object.group_id);
        }
...
exports.Proposal = {
    ...
    fromAmino(object) {
        ...
        if (object.submit_time !== undefined && object.submit_time !== null) {
            message.submitTime = timestamp_1.Timestamp.fromAmino(object.submit_time);
        }
        if (object.group_version !== undefined && object.group_version !== null) {
            message.groupVersion = helpers_1.Long.fromString(object.group_version);
        }
        if (object.group_policy_version !== undefined && object.group_policy_version !== null) {
            message.groupPolicyVersion = helpers_1.Long.fromString(object.group_policy_version);
        }
        ...
        if (object.voting_period_end !== undefined && object.voting_period_end !== null) {
            message.votingPeriodEnd = timestamp_1.Timestamp.fromAmino(object.voting_period_end);
        }
    ...
    toAmino(message) {
        ...
        obj.submit_time = message.submitTime ? timestamp_1.Timestamp.toAmino(message.submitTime) : timestamp_1.Timestamp.fromPartial({});
        ...
        obj.final_tally_result = message.finalTallyResult ? exports.TallyResult.toAmino(message.finalTallyResult) : exports.TallyResult.fromPartial({});
        obj.voting_period_end = message.votingPeriodEnd ? timestamp_1.Timestamp.toAmino(message.votingPeriodEnd) : timestamp_1.Timestamp.fromPartial({});
...
exports.Vote = {
    ...
    fromAmino(object) {
        ...
        if (object.proposal_id !== undefined && object.proposal_id !== null) {
            message.proposalId = helpers_1.Long.fromString(object.proposal_id);
        }
...
const Cosmos_groupv1DecisionPolicy_InterfaceDecoder = (input) => {
    ...
    switch (data.typeUrl) {
        case "/cosmos.group.v1.ThresholdDecisionPolicy":
            return exports.ThresholdDecisionPolicy.decode(data.value, undefined, true);
        case "/cosmos.group.v1.PercentageDecisionPolicy":
            return exports.PercentageDecisionPolicy.decode(data.value, undefined, true);
        default:
            return data;
    }
};
