...
exports.GenesisState = {
    ...
    fromAmino(object) {
        ...
        if (object.group_seq !== undefined && object.group_seq !== null) {
            message.groupSeq = helpers_1.Long.fromString(object.group_seq);
        }
        ...
        if (object.group_policy_seq !== undefined && object.group_policy_seq !== null) {
            message.groupPolicySeq = helpers_1.Long.fromString(object.group_policy_seq);
        }
        ...
        if (object.proposal_seq !== undefined && object.proposal_seq !== null) {
            message.proposalSeq = helpers_1.Long.fromString(object.proposal_seq);
        }
