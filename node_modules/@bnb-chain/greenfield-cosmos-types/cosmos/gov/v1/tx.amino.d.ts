...
export declare const AminoConverter: {
    ...
    "/cosmos.gov.v1.MsgUpdateCrossChainParams": {
        aminoType: string;
        toAmino: (message: MsgUpdateCrossChainParams) => import("./tx").MsgUpdateCrossChainParamsAmino;
        fromAmino: (object: import("./tx").MsgUpdateCrossChainParamsAmino) => MsgUpdateCrossChainParams;
    };
};
