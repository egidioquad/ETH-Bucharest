...
exports.Proposal = {
    ...
    toAmino(message) {
        ...
        obj.submit_time = message.submitTime ? timestamp_1.Timestamp.toAmino(message.submitTime) : undefined;
        obj.deposit_end_time = message.depositEndTime ? timestamp_1.Timestamp.toAmino(message.depositEndTime) : undefined;
        if (message.totalDeposit) {
        ...
        obj.voting_start_time = message.votingStartTime ? timestamp_1.Timestamp.toAmino(message.votingStartTime) : undefined;
        obj.voting_end_time = message.votingEndTime ? timestamp_1.Timestamp.toAmino(message.votingEndTime) : undefined;
        obj.metadata = message.metadata;
        obj.title = message.title;
        obj.summary = message.summary;
        obj.proposer = message.proposer;
...
exports.CrossChainParamsChange = {
    ...
    fromAminoMsg(object) {
        return exports.CrossChainParamsChange.fromAmino(object.value);
    },
    toAminoMsg(message) {
        return {
            type: "cosmos-sdk/v1/CrossChainParamsChange",
            value: exports.CrossChainParamsChange.toAmino(message)
        };
    },
    fromProtoMsg(message) {
        return exports.CrossChainParamsChange.decode(message.value);
    },
    toProto(message) {
        return exports.CrossChainParamsChange.encode(message).finish();
    },
    toProtoMsg(message) {
        return {
            typeUrl: "/cosmos.gov.v1.CrossChainParamsChange",
            value: exports.CrossChainParamsChange.encode(message).finish()
        };
    }
};
