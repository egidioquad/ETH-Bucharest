...
exports.Proposal = {
    ...
    fromAmino(object) {
        ...
        if (object.deposit_end_time !== undefined && object.deposit_end_time !== null) {
            message.depositEndTime = timestamp_1.Timestamp.fromAmino(object.deposit_end_time);
        }
        ...
        if (object.voting_start_time !== undefined && object.voting_start_time !== null) {
            message.votingStartTime = timestamp_1.Timestamp.fromAmino(object.voting_start_time);
        }
        if (object.voting_end_time !== undefined && object.voting_end_time !== null) {
            message.votingEndTime = timestamp_1.Timestamp.fromAmino(object.voting_end_time);
        }
        return message;
    },
    toAmino(message) {
        ...
        obj.deposit_end_time = message.depositEndTime ? timestamp_1.Timestamp.toAmino(message.depositEndTime) : timestamp_1.Timestamp.fromPartial({});
        if (message.totalDeposit) {
        ...
        obj.voting_start_time = message.votingStartTime ? timestamp_1.Timestamp.toAmino(message.votingStartTime) : timestamp_1.Timestamp.fromPartial({});
        obj.voting_end_time = message.votingEndTime ? timestamp_1.Timestamp.toAmino(message.votingEndTime) : timestamp_1.Timestamp.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
...
const Cosmos_govv1beta1Content_InterfaceDecoder = (input) => {
    ...
    switch (data.typeUrl) {
        case "/cosmos.distribution.v1beta1.CommunityPoolSpendProposal":
            return distribution_1.CommunityPoolSpendProposal.decode(data.value, undefined, true);
        case "/cosmos.distribution.v1beta1.CommunityPoolSpendProposalWithDeposit":
            return distribution_1.CommunityPoolSpendProposalWithDeposit.decode(data.value, undefined, true);
        case "/cosmos.gov.v1beta1.TextProposal":
            return exports.TextProposal.decode(data.value, undefined, true);
        case "/cosmos.params.v1beta1.ParameterChangeProposal":
            return params_1.ParameterChangeProposal.decode(data.value, undefined, true);
        default:
            return data;
    }
};
