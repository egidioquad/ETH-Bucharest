        ...
        proposal?: {
            ...
            content?: ({
                ...
                amount?: {
                    ...
                    denom?: string;
                    amount?: string;
                } & Record<Exclude<keyof I["proposal"]["content"]["amount"][number], keyof import("../../base/v1beta1/coin").Coin>, never>)[] & Record<Exclude<keyof I["proposal"]["content"]["amount"], keyof {
                    denom?: string;
                    amount?: string;
                }[]>, never>;
            } & Record<Exclude<keyof I["proposal"]["content"], keyof import("../../distribution/v1beta1/distribution").CommunityPoolSpendProposal>, never>) | ({
                $typeUrl?: "/cosmos.distribution.v1beta1.CommunityPoolSpendProposalWithDeposit";
                title?: string;
                description?: string;
                recipient?: string;
                ...
                amount?: string;
                deposit?: string;
            } & Record<Exclude<keyof I["proposal"]["content"], keyof import("../../distribution/v1beta1/distribution").CommunityPoolSpendProposalWithDeposit>, never>) | ({
                $typeUrl?: "/cosmos.params.v1beta1.ParameterChangeProposal";
                title?: string;
                description?: string;
                changes?: {
                ...
                changes?: {
                    ...
                    key?: string;
                    value?: string;
                } & Record<Exclude<keyof I["proposal"]["content"]["changes"][number], keyof import("../../params/v1beta1/params").ParamChange>, never>)[] & Record<Exclude<keyof I["proposal"]["content"]["changes"], keyof {
                    subspace?: string;
                    key?: string;
                    value?: string;
                }[]>, never>;
            } & Record<Exclude<keyof I["proposal"]["content"], keyof import("../../params/v1beta1/params").ParameterChangeProposal>, never>) | ({
                $typeUrl?: "/cosmos.gov.v1beta1.TextProposal";
                title?: string;
                description?: string;
            } & {
                ...
                title?: string;
                description?: string;
            } & Record<Exclude<keyof I["proposal"]["content"], keyof import("./gov").TextProposal>, never>);
            status?: ProposalStatus;
            finalTallyResult?: {
                yes?: string;
                abstain?: string;
