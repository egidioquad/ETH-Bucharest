...
exports.GenesisState = {
    ...
    fromAmino(object) {
        ...
        if (object.starting_proposal_id !== undefined && object.starting_proposal_id !== null) {
            message.startingProposalId = helpers_1.Long.fromString(object.starting_proposal_id);
        }
    ...
    toAmino(message) {
        ...
        obj.deposit_params = message.depositParams ? gov_1.DepositParams.toAmino(message.depositParams) : gov_1.DepositParams.fromPartial({});
        obj.voting_params = message.votingParams ? gov_1.VotingParams.toAmino(message.votingParams) : gov_1.VotingParams.fromPartial({});
        obj.tally_params = message.tallyParams ? gov_1.TallyParams.toAmino(message.tallyParams) : gov_1.TallyParams.fromPartial({});
        return obj;
    },
    fromAminoMsg(object) {
