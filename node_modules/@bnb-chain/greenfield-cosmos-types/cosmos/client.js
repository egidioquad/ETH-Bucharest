...
const cosmosCrosschainV1TxRegistry = __importStar(require("./crosschain/v1/tx.registry"));
...
const cosmosGashubV1beta1TxRegistry = __importStar(require("./gashub/v1beta1/tx.registry"));
...
const cosmosOracleV1TxRegistry = __importStar(require("./oracle/v1/tx.registry"));
...
const cosmosCrosschainV1TxAmino = __importStar(require("./crosschain/v1/tx.amino"));
...
const cosmosGashubV1beta1TxAmino = __importStar(require("./gashub/v1beta1/tx.amino"));
...
const cosmosOracleV1TxAmino = __importStar(require("./oracle/v1/tx.amino"));
