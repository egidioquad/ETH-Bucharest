      ...
      <div>
        <div className="flex items-center flex-col flex-grow pt-10">
          ...
          <p className="text-center text-lg">
            ...
            <code className="italic bg-green-300 text-base font-bold max-w-full break-words break-all inline-block">
        ...
        <div className="flex-grow bg-green-300 w-full mt-16 px-8 py-12">
          <div className="flex justify-center items-center gap-12 flex-col sm:flex-row">
            <div className="flex flex-col bg-green-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
